...
# Purpose
# -------
# Assign the normalized municipal hydrogeological damage
# score by linking the RASDA damage database to the municipal
# layer.
#
# Municipalities with no recorded hydrogeological damage are
...
# Output
# ------
# D_hydgeo: normalized municipal hydrogeological damage score.
#
...
# ============================================================
#
# Extract the hydrogeological damage scores from the RASDA
# database and store them using the municipal identifier as
# key.
...
# ============================================================
#
# Municipalities without recorded hydrogeological damage are
...
if positive_scores:
    ...
    # Assign the minimum normalized value when no
    # hydrogeological damage is recorded for any municipality.
...
# ============================================================
#
# Store the normalized hydrogeological damage score in the
# D_hydgeo field of the municipal layer.

with edit(layer):

    if 'D_hydgeo' not in layer.fields().names():
...
print("========================================")
print(
    "Hydrogeological damage score assignment completed successfully."
)
print(
    "The normalized values were stored in the D_hydgeo field."
)
print("========================================")