...
# Purpose
# -------
# Evaluate the robustness of the municipal avalanche
...
# Input
# -----
# - Avalanche-hazard polygon layer containing municipal codes,
...
print("")
print("=" * 60)
print("AVALANCHE SENSITIVITY ANALYSIS COMPLETED")
print("=" * 60)
