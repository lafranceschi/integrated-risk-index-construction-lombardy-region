...
# Purpose
# -------
# Assign the normalized municipal avalanche damage score by
# linking the RASDA damage database to the municipal layer.
#
# Municipalities with no recorded avalanche damage are
...
# Output
# ------
# D_aval: normalized municipal avalanche damage score.
#
...
# ============================================================
#
# Extract the avalanche damage scores from the RASDA database
...
# ============================================================
#
# Municipalities without recorded avalanche damage are
...
if positive_scores:
    ...
    # Assign the minimum normalized value when no avalanche
...
# ============================================================
#
# Store the normalized avalanche damage score in the D_aval
# field of the municipal layer.

with edit(layer):

    if 'D_aval' not in layer.fields().names():
...
print("")
print("========================================")
print("Avalanche damage score assignment completed successfully.")
print("The normalized values were stored in the D_aval field.")
print("========================================")