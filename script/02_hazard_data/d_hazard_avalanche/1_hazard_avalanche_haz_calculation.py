...
# Purpose
# -------
# Calculate the normalized municipal avalanche hazard
...
#
# Municipalities with no mapped avalanche hazard are assigned
# the minimum normalized value (0.01), whereas positive hazard
# values are normalized within the interval 0.02–0.99.
#
# Input
# -----
# - Active QGIS layer containing avalanche hazard polygons,
...
# Output
# ------
# P_aval: normalized municipal avalanche hazard indicator.
#
...
# ============================================================
#
# Sum the polygon areas associated with each avalanche hazard
# class within each municipality.
...
if positive_vals:
    ...
    # presents a positive avalanche hazard value.
...
# ============================================================
#
# Store the normalized municipal avalanche hazard indicator
# in the P_aval field.
#
...
if 'P_aval' not in field_names:
    layer.dataProvider().addAttributes([
        QgsField('P_aval', QVariant.Double)
    ])
    layer.updateFields()

idx = layer.fields().indexOf('P_aval')
...
print("")
print("========================================")
print("Avalanche hazard calculation completed successfully.")
print("The normalized values were stored in the P_aval field.")
print("========================================")